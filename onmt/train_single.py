...
def main(opt, device_id, batch_queue=None, semaphore=None):
    ...
    # fields['src'].base_field.vocab.itos.append('<mask>')
    # fields['src'].base_field.vocab.stoi['<mask>'] = len(vocab['src'].base_field.vocab.itos)-1

    # fields['tgt'].base_field.vocab.itos.append('<mask>')
    # fields['tgt'].base_field.vocab.stoi['<mask>'] = len(vocab['src'].base_field.vocab.itos)-1
