...
class TPrompt(nn.Module):
    def __init__(
            self, hidden_size, token_hidden_size, n_head, n_layer, n_block, vocab_size=None,
        ...
        if vocab_size:
            # self.token_fc = nn.Linear(n_prefix_conv*hidden_size, vocab_size)
            self.token_fc = nn.Linear(hidden_size, vocab_size)
